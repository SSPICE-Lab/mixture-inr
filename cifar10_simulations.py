...
DATAPATH = "/data/shared/datasets/images/cifar10"
...
def main(**kwargs):
    ...
    run_name = f"cifar10_{class_name}_{n_images}_{epochs}_{hidden_layers}_{hidden_features}"
    ...
    coords = inr.data.CoordGrid(2, (32, 32)).coord_grid
    ...
    test_coords = inr.data.CoordGrid(2, (32, 32)).coord_grid
    ...
    std_psnr_half = psnrs.std()
    print(f"Average PSNR Half: {psnrs.mean():.2f} dB")

    return average_psnr_half, std_psnr_half, training_time
